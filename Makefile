...
DEBVERSION := 9.0
KERNELS_i386 := "linux-image-4.9.0-7-untangle-686-pae"
KERNELS_amd64 := "linux-image-4.9.0-7-untangle-amd64"
...
CUSTOMSIZE := $(shell echo $$(( 670 * 1024 * 1024 / 2048 )) ) # from MB to 2kB blocks
